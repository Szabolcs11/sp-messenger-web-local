...
function Register({ callback }) {
    ...
    const Register = () => {
        axios.post('http://localhost:1337/api/auth/local/register', {
            ...
            setdefaultavatar(res.data.user.id, 1)
            callback("login")
        }).catch(({response}) => {
    ...
    const setdefaultavatar = async (userid, avatarid) => {
        let dt = avatarid
        const update = await axios({
            method: 'PUT',
            url: 'http://localhost:1337/api/users/'+ userid + "?populate=Avatar",
            data: {
                "Avatar": dt
            }
        })
            ...
            <div className='Login-Container-Main'>
                <div className='Login-Container-Inputs'>
                    ...
                    <div className='Login-Container-Input-Container'>
                        ...
                        <div className='Login-Container-Input'>
                            <input className='Login-Container-InputType' type="email" onChange={e=> {
                ...
                <div className='Login-Container-Button-Container'>
                    <div className='Login-Container-Button' onClick={Register}>
                        Sing up
                    </div>
                </div>
                ...
                <div className='Login-Container-Bottom'>
                    ...
                    <div className='Login-Container-Login-Text' onClick={() => redirectto("login")}>
                        LOGIN
                    </div>
                </div>
            </div>
